...
| 4 | **`mein-ki-toolkit` entscheiden.** Der Artikel steht auf `draft: true`, CLAUDE.md führte ihn als live. Entweder überarbeiten und live stellen (dann Links in den sechs Artikeln optional zurückdrehen) oder aus der Live-Liste streichen. | 15 Min oder 2 Std | Dokumentation und Realität stimmen sonst nicht überein |
