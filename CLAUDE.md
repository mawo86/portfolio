...
- `outputs/xlsx/ki-readiness-check-bewertungsraster.xlsx` (neu, 2026-09-21) — digitales Bewertungsraster: 3 Blätter (Anleitung/Prozesse/Bewertung), rechnet Std./Woche-Umrechnung, Score und Phase (Sofort/3 Monate/Beobachten) automatisch aus. Bindeglied zwischen den Papier-Bögen (Rohdaten-Erfassung) und dem PDF-Report (Ergebnis). Formeln gegen Testdaten aus dem Verdichtungs-Training verifiziert (LibreOffice headless).
