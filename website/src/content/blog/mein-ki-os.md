...
Technisch: Ich nutze [Claude Code](https://claude.ai/code) als Basis. Das ist die CLI-Version von Claude, die direkt im Terminal läuft und auf meine Dateien zugreift. Dazu habe ich eine Ordnerstruktur aufgebaut, die meinen Workspace abbildet.
...
Der Aufbau dauert ein Wochenende. Die Pflege ist minimal. Und der Unterschied im Alltag ist sofort spürbar. Wie [Claude Code](https://claude.ai/code) in der Praxis aussieht, habe ich im Artikel [App bauen ohne Programmierer](/blog/app-bauen-ohne-programmierer) beschrieben.
