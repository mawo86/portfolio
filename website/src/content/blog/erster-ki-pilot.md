---
title: "Dein erster KI-Pilot in 4 Wochen: Ein konkreter Fahrplan"
...
<figure>
  ...
  <figcaption>Ein guter Pilot braucht keinen großen Plan. Er braucht einen klaren Rahmen. (Foto: Unsplash)</figcaption>
</figure>

## Bevor du anfängst: Die Voraussetzungen
...
**Einen messbaren Ausgangswert.** Wie lange dauert der Prozess heute? Wie oft passiert er? Was kostet er? Diese Zahlen brauchst du, um am Ende zu wissen, ob es funktioniert hat.

**Einen Sponsor.** Jemand im Unternehmen, der das Projekt will, Ressourcen freigibt und bei Hindernissen hilft.

Fehlt eine dieser Voraussetzungen, kläre sie zuerst.
...
**Tag 5:** Kick-off mit dem Team. Erklären was kommt, warum, und was sich für sie ändert. Fragen beantworten.
...
Täglich kurze Überprüfung: Was funktioniert? Was nicht? Was muss angepasst werden?

### Woche 3: Testen und Verfeinern

**Echter Betrieb, paralleler Vergleich.** Das System läuft, aber das bisherige Verfahren läuft parallel weiter. Du vergleichst täglich: Was hat das System richtig gemacht? Wo hat es versagt?

Jeder Fehler ist eine Lernmöglichkeit. Prompt anpassen, Logik korrigieren, Ausnahmen behandeln.

Am Ende von Woche 3 sollte das System für 70-80 % der Fälle zuverlässig laufen.
